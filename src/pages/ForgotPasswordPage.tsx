    ...
    >
      {done ? (
        <div className="space-y-4">
          <p className="rounded-xl bg-[var(--accent-soft)] px-3 py-3 text-sm text-[var(--accent)]">
            If that email exists, we sent a password reset link. Check your inbox (and spam).
          </p>
          <Link to="/login" className="inline-block text-sm font-semibold text-[var(--accent)] hover:underline">
            Back to sign in
          </Link>
        </div>
      ) : (
